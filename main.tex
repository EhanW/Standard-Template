...
\cref{sec:intro}, \Cref{sec:intro}, \Cref{equ:1}, \Cref{tab:single,tab:side-by-side,tab:warp-table}, \Cref{fig:single}, \Cref{fig:multiple-images}, \Cref{fig:multiple-images-1}, \Cref{fig:multiple-images-4}, \Cref{alg:algorithm}, \Cref{code}, Code \ref{code}
